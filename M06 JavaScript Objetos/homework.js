...
// console.log(crearGato('Blacky',2))
...
// console.log(agregarPropiedad(obj,'edad'))
...
// console.log(invocarMetodo(obj,'meow'))
...
// }
// console.log(obj);
// console.log(actualizarPassword(obj,'michi2023'))
...
// console.log(agregarAmigo(obj,'Huni'));
// console.log(agregarAmigo(obj,'Minki'));
...
function sumarLikesDeUsuario(objetoUsuario) {
   ...
   // return suma;
   var resultado = objetoUsuario.posts.reduce(function(acc,post){
